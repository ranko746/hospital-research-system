...
const Card = styled.div`
  ${tw`flex flex-col sm:flex-row items-center justify-center text-center h-full mx-4 px-2 py-8`}
  .imageContainer {
  ...
  .description {
    ${tw`mt-1 sm:mt-4 font-medium text-center text-secondary-100 leading-loose`}
  }
`;
